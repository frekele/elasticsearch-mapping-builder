...
public enum FieldType {
    ...
    //###################################################################
    //# [Complex datatypes]
    //## Array datatype - (https://www.elastic.co/guide/en/elasticsearch/reference/5.5/array.html)
    ...
    //## Object datatype - (https://www.elastic.co/guide/en/elasticsearch/reference/5.5/object.html)
    ...
    //## Nested datatype - (https://www.elastic.co/guide/en/elasticsearch/reference/5.5/nested.html)
    ...
    //###################################################################
    //# [Geo datatypes]
    //## Geo-point datatype - (https://www.elastic.co/guide/en/elasticsearch/reference/5.5/geo-point.html)
    ...
    //## Geo-Shape datatype - (https://www.elastic.co/guide/en/elasticsearch/reference/5.5/geo-shape.html)
    ...
    //## IP datatype - (https://www.elastic.co/guide/en/elasticsearch/reference/5.5/ip.html)
    //### An ip field can index/store either IPv4 or IPv6 addresses.
    IP,

    //## Completion datatype - (https://www.elastic.co/guide/en/elasticsearch/reference/5.5/search-suggesters-completion.html)
    ...
    //## Token count datatype - (https://www.elastic.co/guide/en/elasticsearch/reference/5.5/token-count.html)
    ...
    //## mapper-size - (https://www.elastic.co/guide/en/elasticsearch/plugins/5.5/mapper-size.html)
    ...
    //## Attachment datatype - (https://www.elastic.co/guide/en/elasticsearch/plugins/5.5/mapper-attachments.html)
    //MAPPER_ATTACHMENT,

    //## Percolator type - (https://www.elastic.co/guide/en/elasticsearch/reference/5.5/percolator.html)
