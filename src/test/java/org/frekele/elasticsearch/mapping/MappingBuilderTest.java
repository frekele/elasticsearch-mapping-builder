...
public class MappingBuilderTest {
    ...
    public void validateWithoutErrorTest() throws Exception {
        MappingBuilderImpl mappingBuilder = new MappingBuilderImpl(FullDocumentEntity.class);
    ...
    public void validateWithErrorTest() throws Exception {
        MappingBuilderImpl mappingBuilder = new MappingBuilderImpl(NoDocumentEntity.class);
        mappingBuilder.validateElasticDocument();
    }
    ...
    public void buildWithErrorElasticCustomJsonFieldTest() throws Exception {
        MappingBuilderImpl mappingBuilder = new MappingBuilderImpl(IncorrectCustomJsonFieldEntity.class);
    ...
    public void buildTest2() throws Exception {
        ...
        MappingBuilderImpl mappingBuilder = new MappingBuilderImpl(FullDocumentTwoEntity.class);
        ObjectMapping result = mappingBuilder.build();
        assertEquals(result.sourceAsString(), expected);
        //System.out.println(result.sourceAsString());
        System.out.println(mappingBuilder.build(true).sourceAsString());
